...
//        self.lineView.layer.borderWidth = 0.5;
        ...
        self.button.titleLabel.font = fontBoldNum(25);
        self.button.frame = CGRectMake(0, 0, frame.size.width, frame.size.height -0.5);
        self.button.backgroundColor = [UIColor whiteColor];//[UIColor colorWithRed:231/255.0 green:232/255.0 blue:233/255.0 alpha:1];
        [self.button setBackgroundImage:[KeyboardButton imageColor:UIColorFromHex(0xffffff)] forState:UIControlStateNormal];
        [self.button setBackgroundImage:[KeyboardButton imageColor:UIColorFromHex(0xffffff)] forState:UIControlStateHighlighted];

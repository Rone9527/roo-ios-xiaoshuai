...
- (NSURL *)highQualityImageURLForIndex:(NSInteger)index
{
   ...
   if ([self.delegate respondsToSelector:@selector(photoBrowser1: highQualityImageURLForIndex:mainIndex: )]) {
           return [self.delegate photoBrowser1:self highQualityImageURLForIndex:index mainIndex:self.groupIndex];
       }

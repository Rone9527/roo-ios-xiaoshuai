...
- (CABasicAnimation *)scaleAnimation {
    ...
    scaleAnimation.fromValue = @(_multiple);//@1;
...
- (CALayer *)pulsingLayer:(CGRect)rect animation:(CAAnimationGroup *)animationGroup {
    ...
    pulsingLayer.frame = CGRectMake(rect.size.width/4, 0, rect.size.width/2, rect.size.height);
...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.values = @[(__bridge id)SCor_RColor(55,106,255, 0.3).CGColor,
                                    (__bridge id)SCor_RColor(55,106,255, 0.2).CGColor,
                                    (__bridge id)SCor_RColor(55,106,255, 0.1).CGColor,
                                    (__bridge id)SCor_RColor(55,106,255, 0).CGColor];
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)SCor_RColor(55,106,255, 0.3).CGColor,
                                        (__bridge id)SCor_RColor(55,106,255, 0.2).CGColor,
                                        (__bridge id)SCor_RColor(55,106,255, 0.1).CGColor,
                                        (__bridge id)SCor_RColor(55,106,255, 0).CGColor];
...
- (CAAnimationGroup *)animationGroupAnimations:(NSArray *)array {
    ...
    animationGroup.repeatCount = 1;//HUGE;

...
@interface authorFrstView()
@property(nonatomic,strong)UIView *sheetView;
@property(nonatomic,assign)CGFloat higt;

@end

@implementation authorFrstView
...
//    [sheetView  addGestureRecognizer:tap1];
    ...
    UIView*bgv=[[UIView alloc]initWithFrame:CGRectMake(gdValue(15), naLab.bottom+gdValue(20), SCREEN_WIDTH-gdValue(30), gdValue(203))];
    ...
    UILabel*tlab=[[UILabel alloc]initWithFrame:CGRectMake(gdValue(10), log.bottom+gdValue(14), bgv.width-gdValue(20), gdValue(23))];
    tlab.text=@"XXXXXXXXXX";
    ...
    UILabel*tlab1=[[UILabel alloc]initWithFrame:CGRectMake(gdValue(22), tlab.bottom+gdValue(10), bgv.width-gdValue(44), gdValue(60))];
    tlab1.text=[NSString stringWithFormat:getLocalStr(@"dapts8"),@"xxxxxxxx"];
    ...
    for(int i=0;i<2;i++){
        ...
        btn.frame=CGRectMake(gdValue(15)+(wid+gdValue(25))*i, bgv.bottom+gdValue(22), wid, gdValue(50));
    
        btn.titleLabel.font=fontMidNum(16);
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        ViewRadius(btn, gdValue(8));
        if(i==0){
            [btn setTitle:getLocalStr(@"dapts9") forState:UIControlStateNormal];
